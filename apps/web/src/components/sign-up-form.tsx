    ...
    <div className="animate-in fade-in slide-in-from-bottom-6 duration-700">
      <div className="bg-white/70 backdrop-blur-2xl p-8 sm:p-10 rounded-3xl border border-white/80 shadow-2xl shadow-black/5 space-y-7">
        ...
        <div className="text-center space-y-2">
          <h1 className="text-3xl sm:text-4xl font-serif font-black tracking-tight">Create Account</h1>
          <p className="text-muted-foreground text-sm">Start designing your dream wedding invitation</p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-xs">
            <span className="bg-white/70 backdrop-blur-sm px-4 text-muted-foreground font-medium uppercase tracking-widest">or sign up with email</span>
          </div>
        </div>
